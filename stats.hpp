...
extern const string conditions[7];
extern const double conditionMods[7];
...
class Stat {
	public:
		...
		int upside, damTypeIndex, critTypeIndex, posNegIndex, posNegSignIndex, HPContainerIndex, ammoContainerIndex;
